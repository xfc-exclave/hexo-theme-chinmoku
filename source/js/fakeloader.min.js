    ...
    b.fn.fakeLoader = function (m) {
        ...
        d.each(function () {
            ...
            switch (n) {
                ...
                case "spinner5":
                    d.html(h);
                    break; case "spinner6": d.html(g); break; case "spinner7": d.html(e); break; default: d.html(l)
            }
            if (f.imagePath != "") {
        ...
        console.log('xxxx----xxx', window.loadedFlag)
        // setTimeout(function () {
        //     b(d).fadeOut()
        // }, f.timeToHide);
